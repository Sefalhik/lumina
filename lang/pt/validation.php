...
return [
    ...
    'accepted_if' => 'O campo :attribute deve ser aceito quando :other tem o valor :value.',
    ...
    'between' => [
        'array' => 'O array :attribute deve conter entre :min e :max itens.',
        'file' => 'O arquivo :attribute deve ter entre :min e :max quilobytes.',
        'numeric' => 'O valor de :attribute deve estar entre :min e :max.',
        'string' => 'O texto :attribute deve conter entre :min e :max caracteres.',
    ],
    ...
    'declined_if' => 'O campo :attribute deve ser recusado quando :other tem o valor :value.',
    ...
    'gt' => [
        'array' => 'O array :attribute deve conter mais de :value itens.',
        'file' => 'O arquivo :attribute deve ter mais de :value quilobytes.',
        'numeric' => 'O valor de :attribute deve ser maior que :value.',
        'string' => 'O texto :attribute deve conter mais de :value caracteres.',
    ],
    'gte' => [
        'array' => 'O array :attribute deve conter pelo menos :value itens.',
        'file' => 'O arquivo :attribute deve ter no mínimo :value quilobytes.',
        'numeric' => 'O valor de :attribute deve ser maior ou igual a :value.',
        'string' => 'O texto :attribute deve conter pelo menos :value caracteres.',
    ],
    ...
    'json' => 'O campo :attribute deve ser um documento JSON válido.',
    'list' => 'O campo :attribute deve ser uma lista.',
    'lowercase' => 'O campo :attribute deve estar em minúsculas.',
    'lt' => [
        'array' => 'O array :attribute deve conter menos de :value itens.',
        'file' => 'O arquivo :attribute deve ter menos de :value quilobytes.',
        'numeric' => 'O valor de :attribute deve ser menor que :value.',
        'string' => 'O texto :attribute deve conter menos de :value caracteres.',
    ],
    'lte' => [
        'array' => 'O array :attribute deve conter no máximo :value itens.',
        'file' => 'O arquivo :attribute deve ter no máximo :value quilobytes.',
        'numeric' => 'O valor de :attribute deve ser menor ou igual a :value.',
        'string' => 'O texto :attribute deve conter no máximo :value caracteres.',
    ],
    'mac_address' => 'O campo :attribute deve ser um endereço MAC válido.',
    'max' => [
        'array' => 'O array :attribute não deve conter mais de :max itens.',
        'file' => 'O arquivo :attribute não deve exceder :max quilobytes.',
        'numeric' => 'O valor de :attribute não deve ser maior que :max.',
        'string' => 'O texto :attribute não deve conter mais de :max caracteres.',
    ],
    'max_digits' => 'O campo :attribute não deve ter mais de :max dígitos.',
    'mimes' => 'O campo :attribute deve ser um arquivo do tipo: :values.',
    'mimetypes' => 'O campo :attribute deve ser um arquivo do tipo: :values.',
    'min' => [
        'array' => 'O array :attribute deve conter pelo menos :min itens.',
        'file' => 'O arquivo :attribute deve ter no mínimo :min quilobytes.',
        'numeric' => 'O valor de :attribute deve ser maior ou igual a :min.',
        'string' => 'O texto :attribute deve conter pelo menos :min caracteres.',
    ],
    ...
    'multiple_of' => 'O valor de :attribute deve ser um múltiplo de :value.',
    ...
    'password' => [
        ...
        'uncompromised' => 'O valor fornecido para :attribute apareceu em uma violação de dados. Por favor, escolha um valor diferente.',
    ],
    'present' => 'O campo :attribute deve estar presente.',
    'present_if' => 'O campo :attribute deve estar presente quando :other tem o valor :value.',
    ...
    'prohibited_if' => 'O campo :attribute é proibido quando :other tem o valor :value.',
    ...
    'same' => 'Os campos :attribute e :other devem ser idênticos.',
    'size' => [
        ...
        'string' => 'O texto :attribute deve conter :size caracteres.',
    ],
